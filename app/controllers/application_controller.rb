...
class ApplicationController < ActionController::Base
  ...
  protected
    ...
    def configure_permitted_parameters
      devise_parameter_sanitizer.permit(:sign_up, keys: [:name, :postal_code, :address, :description, :avator])
      devise_parameter_sanitizer.permit(:account_update, keys: [:name, :postal_code, :address, :description, :avator])
    end
end
